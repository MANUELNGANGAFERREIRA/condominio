/* ============================================================================
   icons.js
   ----------------------------------------------------------------------------
   Biblioteca de ícones em linha (estilo Feather/Lucide — projetos de ícones
   gratuitos e open-source), embutida como SVG inline para funcionar 100%
   offline, sem depender de nenhum CDN externo. Cada ícone é desenhado em
   stroke, viewBox 24x24, e herda a cor do texto (currentColor) para se
   adaptar a qualquer contexto — sidebar, cartões, badges, botões, etc.
   ============================================================================ */
